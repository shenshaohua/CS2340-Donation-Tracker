...
public class Student implements Parcelable {
    ...
    public ClassStanding getClassStanding() {return _cs;}
    public void setClassStanding(ClassStanding cs) {_cs = cs;}
    ...
    public static int findPosition(Enum classStanding) {
        if (classStanding == ClassStanding.FRESHMAN) {
            return 0;
        } else if (classStanding== ClassStanding.SOPHOMORE) {
            return 1;
        } else if (classStanding == ClassStanding.JUNIOR) {
            return 2;
        } else {
            return 3;
        }
    ...
    public String toString() {
        return _name + " " + _major + " " + _cs.getValue();
    }
    ...
    private Student(Parcel in) {
        ...
        _id = in.readInt();
        _cs = (ClassStanding) in.readSerializable();
