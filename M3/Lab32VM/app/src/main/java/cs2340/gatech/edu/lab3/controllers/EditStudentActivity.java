...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        classStanding = (Spinner) findViewById(R.id.cs);
        /*
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        classStanding.setAdapter(adapter2);
        ...
        if (getIntent().hasExtra(CourseDetailFragment.ARG_STUDENT_ID)) {
            ...
            classStanding.setSelection(Student.findPosition(_student.getClassStanding()));
            editing = true;
        } else {
    ...
    public void onAddPressed(View view) {
        ...
        _student.setClassStanding((ClassStanding) classStanding.getSelectedItem());
